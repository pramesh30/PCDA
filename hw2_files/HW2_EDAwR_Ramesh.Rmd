...
The graph shows that it is skewed towards the right
...
county2.5
histo_lt2.5m <- ggplot(data = county2.5) + geom_histogram (bins = 30, mapping = aes(x = county2.5$Income))
histo_lt2.5m
...
ggplot(county_MI) + geom_boxplot(aes(x = county_MI$peninsula, y = county_MI$Poverty , fill = county_MI$peninsula)) + ggtitle("Distribution of Poverty Vs Peninsula") + xlab("Peninsula") + ylab("Poverty")

ggplot(county_MI) + geom_boxplot(aes(x = county_MI$peninsula, y = county_MI$Citizen , fill = county_MI$peninsula)) + ggtitle("Distribution of Citizen Vs Peninsula") + xlab("Peninsula") + ylab("Citizen")
...
ggplot(county_MI) + geom_boxplot(aes(x = county_MI$peninsula, y = county_MI$Women , fill = county_MI$peninsula)) + ggtitle("Distribution of Women Vs Peninsula") + xlab("Peninsula") + ylab("Income")

ggplot(county_MI) + geom_boxplot(aes(x = county_MI$peninsula, y = county_MI$Men , fill = county_MI$peninsula)) + ggtitle("Distribution of Men Vs Peninsula") + xlab("Peninsular") + ylab("Income")
...
ggplot(data = county_MI, aes(x= county_MI$Income, y = county_MI$MeanCommute, color = peninsula)) + geom_point() + labs(y= "Mean Commute", x = "Income")
