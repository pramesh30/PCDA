...
ggplot(data = county_MI, aes(y = county_MI$Income, x = county_MI$Men, color = peninsula)) + geom_point() + labs(x = "Men", y = "Income") + facet_wrap(~peninsula) + ggtitle("Distirbution of Men Vs Income")
